...
@DisplayName("step 04 - Screening 객체 테스트")
class ScreeningTest {
    ...
    void 영화금액의_순번할인규칙의_금액할인을_적용하고_금액을_확인한다() {
        ...
        final AmountDiscountMovie 아바타 = new AmountDiscountMovie("아바타", Duration.ofMinutes(120), Money.wons(10_000), Money.wons(800), sequenceCondition);
    ...
    void 영화금액의_순번할인규칙의_비율할인을_적용하고_금액을_확인한다() {
        ...
        final SequenceCondition sequenceCondition = new SequenceCondition(1);
        final PercentDiscountMovie 아바타 = new PercentDiscountMovie("아바타", Duration.ofMinutes(120), Money.wons(10_000), 0.2, sequenceCondition);
        final Screening screening = new Screening(아바타, 1, null);
        final Customer 손님 = new Customer("손님", "1");
        final Reservation reserve = screening.reserve(손님, 1);
